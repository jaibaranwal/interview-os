...
async function testBrain() {
  ...
  const analyzer = new CandidateAnalyzer();
  ...
  sm.transitionTo(InterviewState.PLANNING);
  sm.transitionTo(InterviewState.QUESTION);
  sm.transitionTo(InterviewState.LISTENING);
  sm.transitionTo(InterviewState.EVALUATING);
  sm.transitionTo(InterviewState.FOLLOW_UP);
  sm.transitionTo(InterviewState.QUESTION);
  sm.transitionTo(InterviewState.LISTENING);
  sm.transitionTo(InterviewState.EVALUATING);
  sm.transitionTo(InterviewState.FINAL_EVALUATION);
  sm.transitionTo(InterviewState.COMPLETED);
