...
class PromptBuilder {
    buildSystemPrompt(context) {
        const { candidate, analysis, currentState, currentDay, questionCount, visitedDays, difficulty, previousAnswer, evaluation, retryCount } = context;
        ...
        else if (currentState === StateMachine_1.InterviewState.GREETING) {
